package br.com.xmrtecnologia.restwithspringboot3java18.app.security.jwt;
...
public class JwtTokenProvider {
    ...
    protected void init() {
        ...
        // Recebe o valor original, armazenado no arquivo application;yml e faz o encoder
    ...
    public TokenVO createAccessToken(String username, List<String> roles) {
        ...
        // Pegando o momento atual e somando aos Miliseconds setados no application.yml
    ...
    public String resolveToken(HttpServletRequest req) {
        ...
        if (bearerToken != null && bearerToken.startsWith("Bearer ")) {
            ...
            // Retorna somente o token retirando a palavra Bearer e o espaço em branco
