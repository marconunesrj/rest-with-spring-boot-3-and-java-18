...
import br.com.xmrtecnologia.restwithspringboot3java18.app.security.jwt.JwtTokenFilter;
...
public class SecurityConfig {
    ...
    // Vai dizer para o Spring como ele vai Encrypitar a senha para fazer a comparação com a senha que está no Banco de Dados
    @Bean
